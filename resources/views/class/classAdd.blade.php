    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="post" enctype="multipart/form-data" action="/classAdddo">
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">课程图片 :</label>
                                <div class="input-group col-xs-12">
                                    <input type="file"  name="course_page" id="course_page">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control"  rows="4" name="introduce" id="introduce"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <input type="submit" class="btn btn-gradient-primary mr-2" value="添加课程" id="btn">
                </form>
            </div>
        </div>
    </div>
